...
if(isset($_POST['submit'])){
    ...
    $insert_product = "insert into bid_products (bid_p_cat_id,bid_cat_id,date,bid_product_title,bid_product_img1,bid_product_img2,bid_product_img3,bid_product_price,bid_product_keywords,product_desc) values ('$bid_product_cat','$bid_cat',NOW(),'$bid_product_title','$bid_product_img1','$bid_product_img2','$bid_product_img3','$bid_product_price','$bid_product_keywords','$bid_product_desc')";
