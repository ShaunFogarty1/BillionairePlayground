...
if(isset($_POST['submit'])){
    ...
    $bid_email = $_SESSION['bider_email'];
    
    $bid_old_pass = $_POST['old_pass'];
    
    $bid_new_pass = $_POST['new_pass'];
    
    $bid_new_pass_again = $_POST['new_pass_again'];
    
    $sel_c_old_pass = "select * from biders where bider_pass='$bid_old_pass'";
    ...
    $update_c_pass = "update biders set bider_pass='$c_new_pass' where bider_email='$bid_email'";
