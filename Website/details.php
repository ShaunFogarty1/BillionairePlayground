       ...
       <div class="container"><!-- container Begin -->
           <div class="col-md-12"><!-- col-md-12 Begin -->
               ...
               <ul class="breadcrumb"><!-- breadcrumb Begin -->
                   ...
                   <li>
                       <a href="shop.php?p_cat=<?php echo $bid_p_cat_id; ?>"><?php echo $bid_p_cat_title; ?></a>
                   </li>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               <div id="productMain" class="row"><!-- row Begin -->
                       ...
                       <div class="box"><!-- box Begin -->
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               <div class="form-group"><!-- form-group Begin -->
                                   <label for="" class="col-md-5 control-label">Bid €</label>
                                   ...
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                           ...
                                           <input type="text" id="pin" name="pin" maxlength="4" size="4">
                                                        ...
                                                        <p class="text-center buttons" > <a href="checkout.php"> <button class="btn btn-primary i fa fa-gavel"> Place Max Bid</button></a></p>
                               <div class="form-group"><!-- form-group Begin -->
                                   <label class="col-md-5 control-label">QTY OF LOTS</label>
                                   ...
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       ...
                                       <select name="product_size" class="form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Must pick 1 size for the product')"><!-- form-control Begin -->
                                           ...
                                           <option disabled selected>Select QTY OF LOTS</option>
                                           <option>1</option>
                                           <option>2</option>
                                           <option>3</option>
                               ...
                               <p class="price">CURRENT BID: € <?php echo $pro_price; ?></p>
                   ...
                   <div class="box-header"><!-- box-header Begin -->
                     ...
                     <center> <h3>Total Cost Calculation</h3></center>
               ...
               <div class="box" id="details"><!-- box Begin -->
                       ...
                       <h4>Product Details For Biding</h4>
                   ...
                   <p>
				    ...
				    <form action="cart.php" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       $bid_count = mysqli_num_rows($run_cart);
                       
                       ?>
                       
                       <p class="text-muted">You currently have <?php echo $bid_count; ?> item(s) in your bid cart</p>
                           ...
                           <table class="table"><!-- table Begin -->
                                  ...
                                  <?php 
                                   ...
                                   while($row_cart = mysqli_fetch_array($run_cart)){
                                     ...
                                     $pro_qty = $row_cart['qty'];
                                       ...
                                       while($row_products = mysqli_fetch_array($run_products)){
                                           ...
                                           $bid_product_img1 = $row_products['bid_product_img1'];
                                           
                                           $only_price = $row_products['bid_product_price'];
                                   ...
                                   <tr><!-- tr Begin -->
                                       ...
                                       <td>
                                           ...
                                           <img class="img-responsive" src="admin_area/product_images/<?php echo $bid_product_img1; ?>" alt="Product 3a">
                                           
                                       </td>
                                       
                                       <td>
                                           
                                           <a href="details.php?pro_id=<?php echo $pro_id; ?>"> <?php echo $bid_product_title; ?> </a>
                               ...
                               <tfoot><!-- tfoot Begin -->
                                   ...
                                   <tr><!-- tr Begin -->
                                       ...
                                       <th colspan="2">€<?php echo $only_price; ?></th>
                       ...
                       <div class="box-footer"><!-- box-footer Begin -->
                           ...
                           <div class="pull-left"><!-- pull-left Begin -->
                               ...
                               <a href="index.php" class="btn btn-default"><!-- btn btn-default Begin -->
                                   ...
                                   <i class="fa fa-chevron-left"></i> Continue Shopping Bid
               ...
               <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                   <div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Begin -->
                       <div class="box same-height headline"><!-- box same-height headline Begin -->
                           <h3 class="text-center">Bid Products You Maybe Like</h3>
                       </div><!-- box same-height headline Finish -->
                   </div><!-- col-md-3 col-sm-6 Finish -->
                   
                   <?php 
                   
                    $get_products = "select * from bid_products order by rand() LIMIT 0,3";
                        ...
                        <div class='col-md-3 col-sm-6 center-responsive'>
                            ...
                            <div class='product same-height'>
                                ...
                                <div class='text'>
                                    ...
                                    <p class='price'>CURRENT BID: € $pro_price </p>
