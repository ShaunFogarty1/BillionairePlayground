        ...
        <div class="row"><!-- row Begin -->
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
               ...
               <h4>Bid Pages</h4>
                ...
                <ul><!-- ul Begin -->
                    ...
                    <li><a href="customer/my_account.php">My Bid Account</a></li>
                </ul><!-- ul Finish -->
            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <p><!-- p Start -->
                    ...
                    <strong>Billonaire Bid Play Groung.</strong>
                    <br/>Emma
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <form action="" method="post" target="popupwindow" onsubmit="window.open('', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true" method="post"><!-- form begin -->
                    <div class="input-group"><!-- input-group begin -->
                        ...
                        <input type="hidden" value="Billonaire Bid" name="uri"/><input type="hidden" name="loc" value="en_US"/>
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; Year 4 Project 2020-2021</p>
